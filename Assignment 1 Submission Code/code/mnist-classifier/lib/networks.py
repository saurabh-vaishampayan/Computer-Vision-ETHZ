...
class MLPClassifier(nn.Module):
    def __init__(self):
        ...
        #Part 1 of 3.3: Linear Classifier using MLPClassifier class
        #self.layers = nn.Sequential(nn.Linear(28*28, 10))
        
        #Part 2 of 3.3: MLPClassifier with hidden layer size of 32
...
class ConvClassifier(nn.Module):
    def __init__(self):
        ...
        self.layers = nn.Sequential(nn.Conv2d(in_channels=1, out_channels=8, kernel_size=3),
                                    nn.ReLU(),
        ...
        # Output is 10 values (one per class).
        self.classifier = nn.Sequential(nn.Linear(32, 10))
